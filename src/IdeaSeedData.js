const ideaData = [
  {
    ...
    mainFeature: "Using social media in factilitating the growth of ideas",
  ...
  },
  {
    ...
    differentator:
      "text text text text text text text text text text text text text text text text text text text text text text text text text text text text text text text text text text",
    mainFeature: "text text text text text text text text text text text text",
    otherFeature: "text text text text text text text text text text text text",
    targetAud: "text text text text text text text text text text text text",
    usageReason: "text text text text text text text text text text text text",
    imgURL:
      "https://images.unsplash.com/photo-1668902610778-96403019a7f5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2370&q=80",
